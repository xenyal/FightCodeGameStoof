// GLHF
// Vincent Li April 2014
// Documentation can be found: http://fightcodegame.com/docs/?
...
(function () {
    ...
    a.cannonAngleDiff = function (a, b, c) {
        var e = this.strafeArc(a, b).centerPoint;
        var f = b.arena.marginRect.getDistToIntersection(new d(e, e.vectorTo(b.position)), true);
        var g = Math.min(f, e.distanceTo(this.idealPoint(a, b)));
        return (Math.atan2(g - (e.distanceTo(b.position)), 100) * 180 / Math.PI) - (b.strafeDirection * c);
    };
    ...
    a.next = function (a) {
        try {
            ...
            if (b.tracker.isHunting(b)) this.nextTarget(a, b);
    ...
    p.prototype.speed = function (a) {
        ...
        return this.speedSign() * b / this.timeStep();
    };
